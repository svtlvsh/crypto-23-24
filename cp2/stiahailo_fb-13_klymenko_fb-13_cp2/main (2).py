...
def calc_index_alg2(encrypted, r):
    ...
    print('    i:',ind)
    print('AVG:','\n    REF:',sum(ref)/r,'\n    I:',sum(ind)/r)
    return {'r':[r], 'Average Reference value':[sum(ref)/r],'Average I(Y)':[sum(ind)/r]}
...
"""
дорофей львович пивторыкобылы ниразу в жизни не покидал земли хотя прожил уже больше шестидесяти лет работал прорабом строительной
